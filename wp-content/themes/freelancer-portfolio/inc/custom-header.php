...
function freelancerportfolio_header_style() {
	...
	<style type="text/css">
		...
		.main-header.header-fixed {
			background: <?php echo esc_attr(get_theme_mod('header_stickyheaderbgcolor')); ?>;
		}

		.main-header .navbar .navbar-menu ul li a {
			color: <?php echo esc_attr(get_theme_mod('header_menuscolor')); ?> !important;
		}
		...
		#banner-section .banner-top p {
			color: <?php echo esc_attr(get_theme_mod('banner_description_color')); ?>;
		}

		#banner-section .banner-top p {
			border-color: <?php echo esc_attr(get_theme_mod('banner_border_color')); ?>;
		}

		#banner-section .banner-contact {
			background: <?php echo esc_attr(get_theme_mod('banner_boxbg_color')); ?>;
		}
		...
		#banner-section .banner-contact i.fa-map-marker {
			color: <?php echo esc_attr(get_theme_mod('banner_boxicon_color')); ?>;
		}

		#banner-section .banner-contact span,
		#banner-section .banner-contact a, #banner-section .banner-contact p {
			color: <?php echo esc_attr(get_theme_mod('banner_boxtext_color')); ?>;
		}
		
		#banner-section .banner-icons a i{
			color: <?php echo esc_attr(get_theme_mod('banner_socialicon_color')); ?>;
		}

		#banner-section .banner-icons a i{
			background: <?php echo esc_attr(get_theme_mod('banner_socialiconbg_color')); ?>;
		}
